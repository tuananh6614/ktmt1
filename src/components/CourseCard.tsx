...
const CourseCard = ({
  ...
  return (
    <motion.div 
      ...
      className="premium-card overflow-hidden rounded-xl bg-white shadow-lg hover:shadow-xl"
    >
      <Link to={`/khoa-hoc/${id}`} className="block">
        ...
        <div className="p-5">
          <h3 className="font-bold text-dtktmt-blue-dark mb-2 line-clamp-2 text-lg">
            {title}
          </h3>
