  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-12 md:py-20 px-4 overflow-hidden relative">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-dtktmt-blue-dark">
                Học liệu <span className="text-dtktmt-pink-medium">chất lượng</span> cho sinh viên Điện Tử
              </h1>
              ...
              <div className="mt-12 flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-600">Hơn 1000+ học viên hài lòng</p>
                </div>
              </div>
            </div>
            <div className="md:w-1/2 md:pl-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-xl shadow-lg animate-float" style={{ animationDelay: "1.5s" }}>
                  <div className="flex items-center gap-2 text-dtktmt-blue-dark">
          ...
          {/* Decorative elements */}
          <div className="hidden md:block absolute top-1/4 left-10 w-12 h-12 bg-dtktmt-yellow rounded-full opacity-50 animate-float"></div>
          <div className="hidden md:block absolute bottom-1/4 right-10 w-8 h-8 bg-dtktmt-purple-medium rounded-full opacity-50 animate-float" style={{ animationDelay: "2s" }}></div>
        </section>
        ...
        {/* Popular Courses */}
        <section className="py-12 px-4 bg-white/50 backdrop-blur-sm animate-on-scroll opacity-0">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-dtktmt-blue-dark">
                Khóa học nổi bật
              </h2>
              <Link
                to="/khoa-hoc"
                className="text-dtktmt-blue-medium hover:text-dtktmt-blue-dark flex items-center gap-1"
              >
                Xem tất cả
                <ArrowRight size={16} />
              </Link>
        ...
        <section className="py-12 px-4 animate-on-scroll opacity-0">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12 text-dtktmt-blue-dark">
              Tại sao chọn DT&KTMT1?
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="icon-circle w-20 h-20 mx-auto mb-4">
        ...
        <section className="py-12 px-4 animate-on-scroll opacity-0">
          <div className="max-w-7xl mx-auto">
            <div className="bg-gradient-to-r from-dtktmt-blue-medium to-dtktmt-purple-medium rounded-2xl p-8 md:p-12 text-white text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  to="/register"
                  className="bg-white text-dtktmt-blue-dark hover:bg-dtktmt-blue-light hover:text-white px-6 py-3 rounded-full font-medium transition-all"
                >
                  Đăng ký ngay
                </Link>
                <Link
